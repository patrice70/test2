...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: chFj6KlPqALQ/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___9OeNy)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__hEnGn)}>
          <div className={classNames(projectcss.all, sty.freeBox__pVJyz)}>
            {p.renderPlasmicSlot({
