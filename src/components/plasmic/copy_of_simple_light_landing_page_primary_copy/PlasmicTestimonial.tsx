...
import Avatar from "../../Avatar"; // plasmic-import: hHOt5EMbI3q5/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: shghiv6B7ej2/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: rwrIN-GhFubu/icon
import profilepicK0W1ZoZLefl8 from "./images/profilepic.png"; // plasmic-import: k0w1ZoZLefl8/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__mUgfs)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__zs6Qp)}
        >
          <div
            className={classNames(
              projectcss.all,
