...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: ZNKZQF0IMnFe/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__cSxar, {
          [sty.freeBoxlong__cSxarkLkkb]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox___7TMx9, {
            [sty.freeBoxlong___7TMx9KLkkb]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__wKlhe)}
                role={"img"}
              />
            ),
